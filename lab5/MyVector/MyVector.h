...
class MyVector {
 ...
 public:
    MyVector(size_t initial_size = 1) : size(0), max_size(initial_size) { pdata = new T[max_size]; }
    ...
    void sort() { std::sort(pdata, pdata + size); }
...
class MyVector<char*> {
 ...
 public:
    ...
    MyVector(size_t initial_size = 1) : size(0), max_size(initial_size) { pdata = new char*[max_size]; }
